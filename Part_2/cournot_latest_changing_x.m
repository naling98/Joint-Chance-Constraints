...
for chance = 0:1
	...
	S = 25; % Total number of instances
    ...
    disp(['Number of Distribution Nodes : ' num2str(M)]);
    disp('................................................................');   
    disp(' ');
	
    for initial = 10:10:250
        
		disp(['Chance = ' num2str(chance) ' | Initial X : ' num2str(initial) '  . . . ' ]);
		disp(' ');
		rand("seed", 3); %since seed 3 is ideal for our comparision
...
##        disp(' ');
		...
		x = {0,0};
		x{1} = (initial + 5*rand(1,1))*ones(Ni{1}, M);
		x{2} = (initial + 5*rand(1,1))*ones(Ni{2}, M);
        x_initial = x;
        ...
        if chance == 1
            ...
            save(['profile_1_instance' num2str(count)], 'N1','N2','N3','M','beta','delta','c','A_u','A_v','A_s','b','alpha','x_min','x_max','x_initial','x','w','payoffs_history','total_iter', 'opti');
        else
            save(['profile_1_instance_beta' num2str(count)], 'N1','N2','N3','M','beta','delta','c','A_u','A_v','A_s','b','alpha','x_min','x_max','x_initial','x','w','payoffs_history','total_iter', 'opti');
        endif
